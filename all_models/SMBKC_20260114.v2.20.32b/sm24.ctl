...
1998 1998
# Block Group 4: directed fishery
1978 2023 # Block Group 4
# Block Group 5: tests
2021 2023 # Block Group 5:
...
14.3	-7	30	                     0	      -7       30     -2	0	0	0	0	0	0	300		#	log(R0)
10	-7	20	                     1	     -10       20     -1	0	0	0	0	0	0	300		#	log(Rini)
13.39	-7	20	                     0	      -7       20      1	0	0	0	0	0	0	300		#	log(Rbar)

#13.39	-7	20	                     0	      -7       20      1	0	0	0	0	11	5	300		#	log(Rbar)
#13.39	-7	20	                     0	      -7       20      1	2	1	0	0	0	0	300		#	log(Rbar)
#13.39	-7	20	                     0	      -7       20      1	0	0	1	1	0	4	300		#	log(Rbar)

80	30	310 	                     1	    72.5     7.25     -2	0	0	0	0	0	0	300		#	Recruitment
0.25	0.1	7	                     0	     0.1        9     -4	0	0	0	0	0	0	300		#	Recruitment
0.2	0.01	0.75	                     0	     -10     0.75     -4	0	0	0	0	0	0	300		#	log(sigma_R)
0.75	0.2	1	                     3	       3	2     -2	0	0	0	0	0	0	300		#	steepness
0.01	0	1	                     3	    1.01     1.01     -3	0	0	0	0	0	0	300		#	recruitment
## ———————————————————————————————————————————————————————————————————————————————————— ##
## Initial abundance                                                                    ##
# Initial  Lower_bound  Upper_bound Prior_type   Prior_1  Prior_2  Phase  Block Blk_fn  Env_L Env_vr   RW RW_Blk RW_Sigma
14.5	5	20	0	5	20	1	0	0	0	0	0	0	300		#	logN0	vector	of	initial	numbers	at	length	
14	5	20	0	5	20	1	0	0	0	0	0	0	300		#	logN0	vector	of	initial	numbers	at	length	
13.5	5	20	0	5	20	1	0	0	0	0	0	0	300		#	logN0	vector	of	initial	numbers	at	length	

# Initial  Lower_bound  Upper_bound Prior_type   Prior_1  Prior_2  Phase  Relative
...
# Initial  Lower_bound  Upper_bound Prior_type   Prior_1  Prior_2  Phase  Block Blk_fn  Env_L Env_vr   RW RW_Blk RW_Sigma
#    121.5      65.0     145.0           0         0.0      999.0    -4        0      0      3      2    0      4      300    # molt_mu males or combined
#    0.060       0.0       1.0           0         0.0      999.0    -3        0      0      3      2    0      4      300    # molt_cv males or combined
# Initial  Lower_bound  Upper_bound Prior_type   Prior_1  Prior_2  Phase  Relative
#    0.2          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
#    0.3          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
#    0.4          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
#    0.5          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
#    0.6          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
#    0.7          -1         1           0        0.23       0.02    -4        0       # Dev par=2; linear
...
## Relative? Type   Extra  Brkpts  Mirror   Block  Blk_fn Env_L   EnvL_Vr   RW  RW_blk Sigma_RW Mirr_RW
#     0        0       0       0      0         3     0      3       2       0       4   0.3000     0
...
#    0.23      0.01         1             2         0.23        0.02      -4   # M for males
#    1.6        0.0         2             0         0           0          3   # M for males
#    0.1          -1         1             0        0.23        0.02      -4   # Dev par=1
#    0.2          -1         1             0        0.23        0.02      -4   # Dev par=2; linear
#    0.3          -1         1             0        0.23        0.02      -4   # Dev oar=3; power
...
# ##   5: Flat equal to zero (1 parameter; phase must be negative)  UPDATE 2.20.31: description now correct
# ##   6: Flat equal to one (1 parameter; phase must be negative)   UPDATE 2.20.31: description now correct
...
# EXTRA PARS: Initial  Lower_bound  Upper_bound Prior_type      Prior_1     Prior_2  Phase Reltve 
#  0.1        0.001         1.0           0        0         1      -3      0     #--directed fishery, (2009-2023)
#  0.2        0.001         1.0           0        0         1      -3      0     #--directed fishery, (2009-2023) 
#  0.3        0.001         2.0           0        0         1      -2      0     #--directed fishery, (2009-2023). Upper bound must = 2.0
...
## ———————————————————————————————————————————————————————————————————————————————————— ##
#--the number of parameters listed here must match the MAXIMUM composition splicer index
#      Initial    Lower_bound    Upper_bound  Prior_type        Prior_1        Prior_2  Phase 
